--------------------------------------------------------
--  File created - Pazar-Mayýs-29-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence GGLOG_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GGLOG_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
REM INSERTING into GGLOG
SET DEFINE OFF;
Insert into GGLOG (ID,TEXT,ISLEMTARIHI,KULLANICI) values ('2','þifre deðiþti',to_date('29/05/2022','DD/MM/RRRR'),'GG');
Insert into GGLOG (ID,TEXT,ISLEMTARIHI,KULLANICI) values ('3','þifre deðiþti',to_date('29/05/2022','DD/MM/RRRR'),'GG');
Insert into GGLOG (ID,TEXT,ISLEMTARIHI,KULLANICI) values ('4','þifre deðiþti',to_date('29/05/2022','DD/MM/RRRR'),'GG');
Insert into GGLOG (ID,TEXT,ISLEMTARIHI,KULLANICI) values ('5','þifre deðiþti',to_date('29/05/2022','DD/MM/RRRR'),'GG');
Insert into GGLOG (ID,TEXT,ISLEMTARIHI,KULLANICI) values ('6','þifre deðiþti',to_date('29/05/2022','DD/MM/RRRR'),'GG');
...
SET DEFINE OFF;
Insert into KAMPANYA (KAMPANYA_ID,K_ADI,K_ACIKLAMA,K_TUR) values ('4343','ramazan','ramazanýn en güzel indirimi','1');
...
SET DEFINE OFF;
Insert into KULLANICI (KULLANICI_ID,EMAIL,AD,SOYAD,PAROLA,TELEFON,KULLANICI_TURU,ADRES_ID) values ('4              ','esin@gmail.com','esin','kara','123467','5445454545','1','1008');
Insert into KULLANICI (KULLANICI_ID,EMAIL,AD,SOYAD,PAROLA,TELEFON,KULLANICI_TURU,ADRES_ID) values ('3              ','enes@gmail.com','Enes','Karaman','123467','0567897345','1','1001');
Insert into KULLANICI (KULLANICI_ID,EMAIL,AD,SOYAD,PAROLA,TELEFON,KULLANICI_TURU,ADRES_ID) values ('1              ','erdinckiyik@gmail.com','erdinç','kýyýk','123467','5459474155','1','1001');
Insert into KULLANICI (KULLANICI_ID,EMAIL,AD,SOYAD,PAROLA,TELEFON,KULLANICI_TURU,ADRES_ID) values ('2              ','necati99@gmail.com','necati','üstün','12346788','5386642727','1','1002');
...
SET DEFINE OFF;
Insert into URUNLER (URUN_ID,URUN_ADI,URUN_ACIKLAMASI,URUN_FIYATI,KATEGORI_ID) values ('5','CASPERVÝA A3','CASPER ÜRÜNÜ ','3000','1');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007390" ON "GGLOG" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger KULLANICI_SIFRE_DEGIS_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "KULLANICI_SIFRE_DEGIS_TRG" 
BEFORE DELETE OR INSERT OR UPDATE OF PAROLA ON KULLANICI 
...
BEGIN
    ...
    ELSE
        changeType:='D';
    END IF;
    INSERT INTO GGLOG(ID,TEXT,ISLEMTARIHI,KULLANICI)
    VALUES(GGLOG_ID_SEQ.NEXTVAL,'þifre deðiþti',sysdate,user);
END;
/
ALTER TRIGGER "KULLANICI_SIFRE_DEGIS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ADRES_EKLE_TRIG
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "URUN_EKLE" (PURUN_NO IN NUMBER ,PADI VARCHAR2,PACIKLAMA VARCHAR2,
PU_FIYAT NUMBER,PKATEGORINO NUMBER) is
begin
    INSERT INTO URUNLER(URUN_ID,URUN_ADI,URUN_ACIKLAMASI,URUN_FIYATI,KATEGORI_ID) 
    VALUES (PURUN_NO,PADI,PACIKLAMA,PU_FIYAT,PKATEGORINO);
...
/
--------------------------------------------------------
--  DDL for Function KAMPANYA_GETIR
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "KAMPANYA_GETIR" (kampno NUMBER) RETURN VARCHAR2 AS 
uAD VARCHAR2(200);
BEGIN
  SELECT INITCAP(k_adi)
  INTO uAD
  FROM kampanya
  WHERE kampanya_ýd= kampno;
  RETURN uAD;
END KAMPANYA_GETIR;

/
--------------------------------------------------------
--  DDL for Function TASÝYCÝ_ADÝ
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "TASÝYCÝ_ADÝ" (tas_no CHAR) RETURN VARCHAR2 AS 
TAD VARCHAR2(200);
BEGIN
  SELECT INITCAP(tasiyici_adi)
  INTO TAD
  FROM tasiyici
  WHERE tasiyici_ýd= tas_no;
  RETURN TAD;
END TASÝYCÝ_ADÝ;
...
--------------------------------------------------------
--  Constraints for Table GGLOG
--------------------------------------------------------

  ALTER TABLE "GGLOG" ADD PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
